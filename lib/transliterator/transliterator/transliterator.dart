...
abstract class Transliterator<E, S extends Language, T extends Language> {
  ...
  Iterable<Result<E, S, T>> transliterateAll(Iterable<E> inputs, {bool useOutputWriter = false});
}
...
abstract class StringTransliterator<S extends Language, T extends Language> extends Transliterator<String, S, T> {
  ...
  @override
  Iterable<Result<String, S, T>> transliterateAll(Iterable<String> inputs, {bool useOutputWriter = false}) =>
