...
abstract class Dictionary<S extends Script, T extends Script> extends MapBase<String, String> {
  ...
  static TempDictionary<S, T> union<S extends Script, T extends Script>(Iterable<Dictionary<S, T>> dictionaries) {
    final TempDictionary<S, T> combinedDictionary = TempDictionary<S, T>();

    dictionaries.forEach(combinedDictionary.addAll);
  ...
  HashMap<String, String> parseEntriesFromString(String data) =>
